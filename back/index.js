...
app.get("/dentistry_clinic_admin/doctors", async (req, res) => {
  ...
  app.post("/dentistry_clinic_admin/doctors/", async (req, res) => {
    try {
      ...
      res.json({ message: "Doctor added successfully", doctorId: result.insertedId });
    } catch (e) {
  ...
  app.post("/dentistry_clinic_admin/procedures/", async (req, res) => {
    try {
      ...
      res.json({ message: "Procedure added successfully", procedureId: result.insertedId });
    } catch (e) {
  ...
  app.post("/dentistry_clinic_admin/appointments/", async (req, res) => {
    try {
      ...
      res.json({ message: "Appointment added successfully", appointmentId: result.insertedId });
    } catch (e) {
  ...
  app.post("/dentistry_clinic_admin/schedules/", async (req, res) => {
    try {
      ...
      res.json({ message: "Schedule added successfully", scheduleId: result.insertedId });
    } catch (e) {
